    ...
    <div class="flex flex-col h-full px-8 py-2 border-8 box-border bg-slate-300 rounded-lg">
        ...
        <ul class='overflow-y-auto' >
            ...
            <a href="/order/{{$order->id}}">
                <li class="flex flex-col py-1 px-2 my-1 text-black border-2 rounded-md border-slate-400 bg-slate-200 cursor-pointer hover:border-slate-700 hover:bg-slate-50">
