...
<div class="h-full w-screen p-8">
    <div class="relative flex flex-col h-full px-8 py-2 border-8 box-border bg-slate-300 rounded-lg">
        ...
        <h1 class="text-xl text-center my-2 font-bold">Order {{$order->id}}</h1>
        <div class="flex flex-col py-1 px-2 my-1 border-2 rounded-md border-slate-400 bg-slate-200 hover:border-slate-700 hover:bg-slate-50">
          ...
          <h2 class="font-bold text-lg">Items</h2>
            <div class="flex flex-col overflow-y-auto py-1 px-2 my-1 border-2 rounded-md border-slate-400 bg-slate-200 hover:border-slate-700 hover:bg-slate-50">
            <table>
              <tr>
